...
**Answer: Each student's answer comparing their estimates will be slightly different (such is the nature of random sampling.) In most cases, the estimates should be relatively similar to the true proportion of .16, but are unlikely to be exactly .16, and it is unlikely any two samples will produce identical estimates.**

**As to _why_ their samples differed, students should explain that each estimate was based on a random sample of people, and the people observed are likely to be different from sample to sample. In other words, the difference in estimates was due to sampling variability.**
...
**Answer: 0.12 to 0.14 appeared to be the most common value, while values above .3 were very uncommon. Of course, these values will differ from student to student. When grading, look for comprehension that the CENTER of the distribution has more common values, and the tails of the distribution are less common values.**
