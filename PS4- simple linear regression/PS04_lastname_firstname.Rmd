...
If Representative Ocasio-Cortez saw the regression line and not the actual data, what would her prediction of Trump support be for a region with 50% of people that identify as non-white? Would her prediction be an overestimate or an underestimate (compared to the observed data), and by how much? In other words, what is the residual for this prediction? 
