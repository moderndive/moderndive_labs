...
**Answer:** No because this is not an experiment, this is an observational study. The levels of white poverty were not randomly assigned. 
...
**NOTE TO GRADER: STUDENTS CAN CALCULATE THE PREDICTION AND RESIDUAL MANUALLY, OR GET WITH THE GET REGRESSION POINTS FUNCTION AS I DID BELOW....AS LONG AS THEY COME UP WITH THE ANSWER**
...
**A** The model predicts 41.912% Trump support 

**B** The observed value at `non_white` (ID 2) was 33% Trump support. The model thus overpredicted. 

**C** The residual is (observed - predicted)...33- 41.912, -8.912 (OK if they are a little off due to rounding)
