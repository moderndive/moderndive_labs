...
### 1. On each histogram above, please draw two vertical lines, so that the ROUGHLY the middle 95% of the values in each histogram are encompassed by the two vertical lines. You will need to "eyeball" this.  
