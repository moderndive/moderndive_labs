...
* Get a sense for the requirements of this project phase by reading a possible [example data proposal](static/term_project/1_data_proposal.html){target="_blank"} `r submission_will_differ`: 
