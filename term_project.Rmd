...
* Get a sense for the requirements of this project phase by reading a possible [example data proposal](static/term_project/1_data_proposal_example.html){target="_blank"} `r submission_will_differ`: 
* Download the following <a href="static/term_project/1_data_proposal.Rmd" download>`project_data.Rmd`</a> template R Markdown file and fill it in. 
...
* **Where is this heading?**: For the next project phase (project proposal), you will be making a visualization like this [one](static/term_project/2_project_proposal_example.html#colored-scatterplot){target="_blank"}. If you can make a visualization like this one, then your data is set for the rest of the project.
...
* Get a sense for the requirements of this project phase by reading a possible [project proposal](static/term_project/2_project_proposal_example.html){target="_blank"} `r submission_will_differ`: 
* Download the following <a href="static/term_project/2_project_proposal.Rmd" download>`project_proposal.Rmd`</a> template R Markdown file and start filling it in. 
...
* Get a sense for the requirements of this project phase by reading only the following sections of this possible [project resubmission](static/term_project/4_resubmission_example.html){target="_blank"} `r submission_will_differ`: 
...
* Download the following <a href="static/term_project/3_submission_example.Rmd" download>`project_submission_example.Rmd`</a> template R Markdown file and start filling it in.
...
Get a sense for the requirements of this project phase by reading all the sections of the possible [project resubmission](static/term_project/4_resubmission_example.html){target="_blank"} that you read earlier. In particular the following new sections:
