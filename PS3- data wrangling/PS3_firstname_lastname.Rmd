...
---
title: "Problem Set 3: Data Wrangling Solutions"
...
## Question 11
Generate a single table that shows the total number of houses sold in Austin in 2000 and 2001 (total over the entire period), & the total number of houses sold in Dallas in 2000 and 2001 (total over the entire period). This calculation requires a number of steps, so it might help to want to write out **pseudocode**, or steps that sets out a "blueprint" of your chain. 
