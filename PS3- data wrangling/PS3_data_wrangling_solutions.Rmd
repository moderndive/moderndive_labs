...
**note to grader: the c("item", "item") the separate == inside the filter commands are both acceptable, and the filtering can also be done in one step!** 
