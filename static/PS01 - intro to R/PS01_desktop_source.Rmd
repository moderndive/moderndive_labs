...
Each week you will submit an **html** file with all your code and text on Moodle. The steps to do this are as follows: 

- Make sure you **knit a final copy with all your changes** and work
- Look at your final html file in a web browser to make sure it contains the work you expect, and is formatted properly (e.g. 11-12 Exercise headers, each with answers for this week)
- Locate the HTML file on your computer's hard drive. It should be found in the same folder as the R Markdown document where you did your work.
